                  ...
                  <div class="tab-pane" id="agregarEmpleado">
                    ...
                    <div class="row ">
                      <div  class=" col-sm-4 col-md-4  col-12  ">
                        <label class="col form-label " for="celular" >CI-NIT</label>

                        <input class="col form-control form-control-sm" type="number" id="ci" name="ci" placeholder="Celular" required autofocus>
                      </div>
                      <div  class=" col-sm-4 col-md-4  col-12  ">
