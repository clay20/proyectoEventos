...
<script src="<?php echo base_url();?>/calendario/jquery.js.descarga"></script>

<script src="<?php echo base_url();?>/calendario/momentjs.lang.js"></script>ss

<script src="<?php echo base_url();?>/calendario/bootstrap.min.js.descarga"></script>
<script src="<?php echo base_url();?>/calendario/underscore-min.js"></script>

<script src="<?php echo base_url();?>/calendario/clndr.min.js.descarga"></script>
<script src="<?php echo base_url();?>/calendario/footerCalendrio.jss"></script> -->
